...
export const ServiceCard: React.FC<IServiceCard> = ({ cardData, number }) => {
  ...
  return (
    <div className="w-full max-w-[573px] flex flex-col md:flex-row xl:flex-col items-center gap-[24px] md:gap-[46px] xl:gap-[64px]">
      ...
      <div className=" flex flex-col gap-[16px] xl:gap-[28px] text-center md:text-left xl:text-center w-full">
        <p className=" font-fraunces text-heading-XS xl:text-headingS  text-dark-purple">
          {name}
        </p>
