...
export const YourResult = () => {
  return (
    <div className=" container-wide  flex flex-col items-center md:flex-row gap-[48px] md:gap-[78px] xl:gap-[131px]  md:ml-[-110px] xl:ml-0 ">
      <Image
      ...
      <div className="flex-1 max-md:padding-x">
